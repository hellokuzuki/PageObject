...
public class Page {
    ...
    public static Xls_Reader xls1= new Xls_Reader(System.getProperty("user.dir")+"//src//test//java//com//totsy//xls//TestCases.xlsx");
    ...
    public Page(){
        ...
        if (driver == null) {
            ...
            try {
                ...
                FileInputStream fs = new FileInputStream(System.getProperty("user.dir")+"\\src\\test\\java\\com\\totsy\\config\\config.properties");
                CONFIG.load(fs);

                // Load the OR Properties
                fs= new FileInputStream(System.getProperty("user.dir")+"\\src\\test\\java\\com\\totsy\\config\\OR.properties");
                OR.load(fs);
